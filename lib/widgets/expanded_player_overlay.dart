...
class ExpandedPlayerOverlay extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ExpandedPlayerOverlay> createState() =>
      _ExpandedPlayerOverlayState();
}

class _ExpandedPlayerOverlayState extends ConsumerState<ExpandedPlayerOverlay> {
  ...
  Widget _buildContent(BuildContext context) {
    ...
    final artSize = screenSize.width * 0.75;
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Track title (Playfair Display italic)
                        Text(
